...
########################################################################
# This is a Machine Learning with RDBMS
# Language: Python and MySQL
#
# Title : Determine the Propensity to Develop Non-Communicable Disease 
# A Classification Project using Python and Boosting Ensembles
#
# DataSet: Breast Cancer Data from UCI Repository
...
def evaluateAlgorithm(train_X, test_X, train_Y, test_Y, dataset):
    ...
    #####################################################################
    # -------------------------------------------------------------------
    # Explore Gradient Boosting from scikit-learn
    # -------------------------------------------------------------------
    # 1. Gradient Boosting Algorithm: GradientBoostingClassifier() 
    # -------------------------------------------------------------------
    # -------------------------------------------------------------------
    ...
    description.append('GradBoost_1')
    
    # Cross Validation Results
    print("\n%s: " % ('GradBoost Algorithm: PS-1'))
    ...
    model_List.append(('GradBoost_1', 'GradBoost Algorithm: PS-1', 
                        trained_Model, acc, kappa_score, 
                        classReport, confMatrix))

    # -------------------------------------------------------------------    
    # Algorithm initialisation - PS - 2   
    GradBoost_2 = GradientBoostingClassifier(
    ...
    cv_results = cross_val_score(model, train_X, train_Y, 
                                 ...
                                 n_jobs = 4, verbose = 0)
    cv_outcomes.append(cv_results)
    description.append('GradBoost_2')
    
    # Cross Validation Results
    print("\n%s: " % ('GradBoost Algorithm: PS-2'))    
    prt_string = "CV Mean Accuracy: %f (Std: %f)"% (
                                    cv_results.mean(), 
                                    cv_results.std())
    print(prt_string)
    ...
    # collect performance results for further reporting
    model_List.append(('GradBoost_2', 'GradBoost Algorithm: PS-2', 
                        trained_Model, acc, kappa_score, 
                        classReport, confMatrix))
    ...
    model = GradientBoostingClassifier(
                        ...
                        random_state=randomSeed, max_features=None, 
    ...
    cv_results = cross_val_score(model, train_X, train_Y, 
                                 ...
                                 n_jobs = 4, verbose = 0)
    cv_outcomes.append(cv_results)
    description.append('GradBoost_3')
    
    # Cross Validation Results
    print("\n%s: " % ('GradBoost Algorithm: PS-3'))    
    prt_string = "CV Mean Accuracy: %f (Std: %f)"% (
                                    cv_results.mean(), 
                                    cv_results.std())
    print(prt_string)
    ...
    # collect performance results for further reporting
    model_List.append(('GradBoost_3', 'GradBoost Algorithm: PS-3', 
                        trained_Model, acc, kappa_score, 
                        classReport, confMatrix))    
    ...
    cv_results = cross_val_score(model, train_X, train_Y, 
                                 ...
                                 n_jobs = 4, verbose = 0)
    cv_outcomes.append(cv_results)
    description.append('GradBoost_4')
    
    # Cross Validation Results
    print("\n%s: " % ('GradBoost Algorithm: PS-4'))    
    prt_string = "CV Mean Accuracy: %f (Std: %f)"% (
                                    cv_results.mean(), 
                                    cv_results.std())
    print(prt_string)
    ...
    # collect performance results for further reporting
    model_List.append(('GradBoost_4', 'GradBoost Algorithm: PS-4', 
                        trained_Model, acc, kappa_score, 
                        classReport, confMatrix)) 
...
def featureRank_Analysis(model, pred_dataset, cols):
    ...
    tree.export_graphviz(
            ...
            model.steps[1][1].estimators_[sub_tree_number, 0], 
            out_file = dotfile, 
...
def loadTrainedModelForPrediction(dataset):
    f = open('model_GradBoost_4.pickle', 'rb')
