...
def evaluateAlgorithm(train_X, test_X, train_Y, test_Y, dataset):
    ...
    # -------------------------------------------------------------------
    # Explore lightgbm Algorithm from LightGBM
    # -------------------------------------------------------------------
    # Gradient Boosting i.e. lightgbm Algorithm 
    # -------------------------------------------------------------------

    # -------------------------------------------------------------------
    # Algorithm initialisation - PS - 1   
    LightGBM_1 = lgb.LGBMClassifier(boosting_type='gbdt', 
                    objective='binary', 
                    #num_class=2,
                    num_iteration=10000, 
    ...
    description.append('LightGBM_1')
    
    # Cross Validation Results
    print("\n%s: " % ('LightGBM Algorithm: PS-1'))    
    ...
    model_List.append(('LightGBM_1', 'LightGBM Algorithm: PS-1', 
                        trained_Model, acc, kappa_score, 
                        classReport, confMatrix))  

    # -------------------------------------------------------------------
    # Algorithm initialisation - PS - 2   
    LightGBM_2 = lgb.LGBMClassifier(boosting_type='gbdt', 
                    objective='binary', 
                    #num_class=2,
                    num_iteration=5000, 
    ...
    cv_results = cross_val_score(model, train_X, train_Y, 
                                 ...
                                 n_jobs = 4, verbose = 0)
    cv_outcomes.append(cv_results)
    description.append('LightGBM_2')
    
    # Cross Validation Results
    print("\n%s: " % ('LightGBM Algorithm: PS-2'))    
    prt_string = "CV Mean Accuracy: %f (Std: %f)"% (
                                    cv_results.mean(), 
                                    cv_results.std())
    print(prt_string)
    ...
    # collect performance results for further reporting
    model_List.append(('LightGBM_1', 'LightGBM Algorithm: PS-2', 
                        trained_Model, acc, kappa_score, 
                        classReport, confMatrix))

    # -------------------------------------------------------------------    
    # Algorithm initialisation - PS - 3   
    LightGBM_3 = lgb.LGBMClassifier(boosting_type='gbdt', 
                    objective='binary', 
                    #num_class=2,
                    num_iteration=1000, 
    ...
    # collect performance results for further reporting
    model_List.append(('LightGBM_3', 'LightGBM Algorithm: PS-3', 
                        trained_Model, acc, kappa_score, 
                        classReport, confMatrix))
    ...
    cv_results = cross_val_score(model, train_X, train_Y, 
                                 ...
                                 n_jobs = 4, verbose = 0)
    cv_outcomes.append(cv_results)
    description.append('LightGBM_4')
    
    # Cross Validation Results
    print("\n%s: " % ('LightGBM Algorithm: PS-4'))    
    prt_string = "CV Mean Accuracy: %f (Std: %f)"% (
                                    cv_results.mean(), 
                                    cv_results.std())
    print(prt_string)
    ...
    # collect performance results for further reporting
    model_List.append(('LightGBM_4', 'LightGBM Algorithm: PS-4', 
                        trained_Model, acc, kappa_score, 
                        classReport, confMatrix))    
    ...
    parameters = {'max_depth'     : sp_randInt(4, 10),
                  ...
                  'num_iteration' : sp_randInt(10, 100),
    ...
    cv_results = cross_val_score(model, train_X, train_Y, 
                                 ...
                                 n_jobs = 4, verbose = 0)
    cv_outcomes.append(cv_results)
    description.append('LightGBM_5')
    
    # Cross Validation Results
    print("\n%s: " % ('LightGBM Algorithm: PS-5'))    
    prt_string = "CV Mean Accuracy: %f (Std: %f)"% (
                                    cv_results.mean(), 
                                    cv_results.std())
    print(prt_string)
    ...
    # collect performance results for further reporting
    model_List.append(('LightGBM_5', 'LightGBM Algorithm: PS-5', 
                        trained_Model, acc, kappa_score, 
                        classReport, confMatrix)) 
...
def loadTrainedModelForPrediction(dataset):
    f = open('model_LightGBM_5.pickle', 'rb')
